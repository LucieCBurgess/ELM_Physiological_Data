...
/**
  * Created by lucieburgess on 29/08/2017.
  * ml.utils.SchemaUtil is private to the API so having to create my own. This is a known issue in the Spark API.
  * From https://github.com/apache/spark/blob/master/mllib/src/main/scala/org/apache/spark/ml/util/SchemaUtils.scala
  * Contains utils for handling schemas.
  * I have not unit tested this code as it is lifted straight from the Spark API.
  */
object ELMSchemaUtils {
